...
module Vusb :
sig
  val vusb_plug : xs:Xenstore.Xs.xsh -> priv:bool -> domid:Xenctrl.domid -> id:string -> hostbus:string -> hostport: string -> version: string-> unit
  val vusb_unplug : xs:Xenstore.Xs.xsh -> priv:bool -> domid:Xenctrl.domid -> id:string -> hostbus:string -> hostport:string -> unit
